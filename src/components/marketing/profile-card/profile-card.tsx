...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  const getSocialIcon = (platform: string) => {
    const iconClass = "w-5 h-5 text-blue-600 hover:text-blue-900 ";
  ...
  return (
    <div
      className={`w-[340px] bg-white rounded-xl shadow-sm border border-gray-200 p-8 ${className}`}
    >
          ...
          <div className="flex items-center justify-center gap-4">
            {socialLinks.map((link, index) => (
              <a
                ...
                className="rounded-md p-2transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                target="_blank"
